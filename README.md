<h2 align="center">:helicopter:浙江师范大学疫情每日打卡自动填报</h2>
<p align="center">
    ...
    <img src="https://img.shields.io/badge/python-%3d%203.x-blue" alt="Python Version">
</p>


# Version 1.0
## 环境配置
- 需在服务器（不关机的电脑上）上启动定时服务，需要安装python3环境
- 固定打卡地址
...
### 1、下载项目
#### git
在PC上开启一个终端，使用git指令download
```python3
git clone https://github.com/549506247xxl/zjnu-auto-clock.git
```
#### 直接下载
图片
